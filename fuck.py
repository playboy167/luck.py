...
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS IS MAKE BY (PLAY BOY) ")
time.sleep(5)
...
\033[1;35m█  \033[1;34m[\033[1;35m•\033[1;34m] \033[1;36mAuthor   \033[1;34m :\033[1;36m   PLAY_BOY                           
\033[1;35m█\033[1;34m  [\033[1;35m•\033[1;34m] \033[1;33mWhatsapp  \033[1;34m: \033[1;33m    +8801979526394      
\033[1;35m█\033[1;34m  [\033[1;35m•\033[1;34m] \033[1;31mGitHub  \033[1;34m  :\033[1;31m   @playboy167              
\033[1;35m█\033[1;34m  [\033[1;35m•\033[1;34m] \033[1;37mYoutub  \033[1;34m:   \033[1;37mOFFLINE__BOY
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/playboy167/offline-approval.txt"])
...
def notice():
	...
	runtxt("\033[0;97m THIS YOUR KEY COPY TO ➪ >> %s%s"%(P, offline))
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/playboy167/offline-approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;34m╚═════════════════════════════════════════╝""")
		...
		print("%s [%s•%s] %sTOOL TYPE : %sOLD IDZ 2009"%(P,L,A,Y))
		print("%s [%s•%s] %sVERSION   : %sV1.0"%(P,L,A,Y))
		...
		print("───────────────────────────────────────────────────────× ")
		print("%s [%sN%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(PAID)"%(P,L,A,Y))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n%s [=>] USE %s, %s(COMMA)%s FOR SEPARATOR "%(P,L,A,Y))
				print("%s EXAMPLE : %s123456,123456789"%(Y,G))
				listpass = input("%s [=>] TYPE (123456,123456789) :%s "%(P,B))
				print("───────────────────────────────────────────────────────× ")
				if len(listpass)<=5:
